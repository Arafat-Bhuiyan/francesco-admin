    ...
    <div className="p-8 bg-[#FBFBFB] min-h-screen">
      ...
      <div className="inline-flex p-1 bg-[#101828] rounded-full mb-6">
        <button
          ...
          className={`px-8 py-2.5 rounded-full text-sm font-bold transition-all ${activeTab === "admins"
        ...
        <button
          ...
          className={`px-8 py-2.5 rounded-full text-sm font-bold transition-all ${activeTab === "agents"
              ? "bg-white text-[#101828]"
              : "text-white hover:bg-white/10"
            }`}
        >
      ...
      <div className="bg-white rounded-md border border-gray-100 shadow-sm p-8 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-8 rounded-md border border-gray-100 shadow-sm text-center">
