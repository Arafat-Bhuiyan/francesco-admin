...
const AdminsTable = () => {
  ...
  return (
    <div className="bg-white rounded-[2rem] border border-gray-100 p-10 shadow-sm animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            >
              ...
              <td className="py-5">
                <span
                  className={`px-3 py-1 rounded-lg text-xs font-bold text-white transition-all ${
                    admin.status === "Active" ? "bg-[#00C26F]" : "bg-[#94A3B8]"
                  }`}
                >
                  {admin.status}
                </span>
              ...
              <td className="py-5">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 border rounded-xl font-bold text-sm transition-all shadow-sm ${
                    admin.status === "Active"
